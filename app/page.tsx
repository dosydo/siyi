...
<section className="closing" id="contact"><div className="wrap"><div><p>让附近想运动的人，认识你的好课程。</p><h2>下一次被选择，<br/>从被看见开始。</h2></div><div className="contact-panel"><div className="contact-details"><span className="contact-label">招商咨询电话</span><a className="contact-number" href={merchantPhoneHref} aria-label={`拨打思翊招商咨询电话 ${merchantPhone}`}>{merchantPhone}</a><div className="contact-actions"><a className="button lime" href={merchantPhoneHref}><Phone size={19}/> 电话咨询入驻</a><a className="contact-prepare" href="#prepare">查看入驻资料 <ArrowUpRight size={17}/></a></div><p>欢迎瑜伽、普拉提、健身等运动场馆咨询合作。<br/>正式入驻入口将于上线后公布。</p></div><figure className="contact-qr"><img src={`${assetBase}customer-service-qr.jpg`} alt="思翊企业客服二维码" width="875" height="875" loading="lazy"/><figcaption><strong>扫码添加客服</strong><span>微信扫码，咨询商户入驻</span></figcaption></figure></div></div></section>
